<?php
	...
	class FileElement extends LabelledResultElement
	{
		...
		{
			return parent::getProps() + ["accept" => $this->accept];
		}
		 ...
		 * @return	string|null		The default label, or an object if this is a group element, or null if this element shouldn't generate a label
		 */
		public function getDefaultGeneratorLabel()
		{
			return null;
		}
	}