<?php
	...
	class Image extends File
	{
		 ...
		 * @param	bool	$absolute	Whether to use an absolute link
		 * @return	string				The resulting tag
		 */
		public function tag($class = "", $alt = "", $id = "", $absolute = false)
		{
			$link = $absolute ? $this->getFullLink() : $this->getLink();
			$alt = htmlentities($alt, ENT_QUOTES | ENT_XHTML);
			
			return "<img src='{$link}' width='{$this->width}' height='{$this->height}' alt='{$alt}' class='{$class}' id='{$id}' />\n";
		}
	}