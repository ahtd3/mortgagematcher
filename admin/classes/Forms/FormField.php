<?php
	...
	class FormField extends Generator
	{
		...
		protected function elements()
		{
			...
			$this->addElement((new Group("columns", function(Group $columns)
			{
				$columns->add((new Group("left", function(Group $left)
				{
				...
				$columns->add((new Group("right", function(Group $right)
				{
